...
export function InternalStudioHome() {
  return (
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 pb-20 pt-10 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:px-10 lg:pb-28 lg:pt-16">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Link href="/salons/new" className="btn btn-primary px-6 py-3">
              Criar perfil do salão
              <ArrowRight className="h-4 w-4" />
            </Link>
            <Link href="/salons/import" className="btn btn-secondary px-6 py-3">
              Importar planilha
            </Link>
            <Link href="/salons" className="btn btn-secondary px-6 py-3">
              Ver salões salvos
            </Link>
          </div>
        </div>

      ...
      {template === "premium_editorial" ? (
        <div className="mt-6 grid gap-5 border-t border-zinc-100 pt-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <label className="grid gap-2"><span className="text-sm font-semibold text-zinc-800">Cor da fonte dos botoes de agendar</span><input type="color" value={premiumEditorial.bookingButtonTextColor || "#ffffff"} onChange={(event) => updateField("bookingButtonTextColor", event.target.value)} className="h-12 w-full rounded-2xl border border-zinc-200 bg-zinc-50 p-2" /></label>
            <label className="grid gap-2"><span className="text-sm font-semibold text-zinc-800">Cor da fonte do botao de Instagram</span><input type="color" value={premiumEditorial.instagramButtonTextColor || "#281916"} onChange={(event) => updateField("instagramButtonTextColor", event.target.value)} className="h-12 w-full rounded-2xl border border-zinc-200 bg-zinc-50 p-2" /></label>
